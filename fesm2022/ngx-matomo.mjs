...
import { InjectionToken, inject, Injectable, PLATFORM_ID, Injector, NgModule } from '@angular/core';
...
export { MATOMO_CONFIGURATION, MatomoInjector, MatomoModule, MatomoRouteTracker, MatomoTracker };
